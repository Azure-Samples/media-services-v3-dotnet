...
var transform = await CreateTransformAsync(mediaServicesAccount, CAETransformName);
...
Console.WriteLine();
Console.WriteLine($"https://ampdemo.azureedge.net/?url={HttpUtility.UrlEncode(smoothPath.ToString())}&aes=true&aestoken=Bearer%20{token}");
Console.WriteLine();
           ...
           Outputs =
           {
               ...
               (
                   ...
                   preset: new BuiltInStandardEncoderPreset(
                       // This sample uses the built-in content aware encoding preset for Adaptive Bit-rate Streaming.
