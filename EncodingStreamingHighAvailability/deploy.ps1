...
$functionFolders = @{JobScheduler="HighAvailability.JobScheduler"; JobStatus="HighAvailability.JobStatus"; StreamProvisioning="HighAvailability.StreamProvisioning"; JobVerification="HighAvailability.JobVerification"}
