...
const string BaseSourceUri = "https://nimbuscdn-nimbuspm.streaming.mediaservices.windows.net/2b533311-b215-4409-80af-529c3e853622/";
const string FileSourceUri = "Ignite-short.mp4";
...
if (job.Data.State == MediaJobState.Error)
{
    ...
    await CleanUpAsync(transform, job, outputAsset, null, stopStreamingEndpoint, null);
    return;
}
...
await CleanUpAsync(transform, job, outputAsset, streamingLocator, stopStreamingEndpoint, streamingEndpoint);
