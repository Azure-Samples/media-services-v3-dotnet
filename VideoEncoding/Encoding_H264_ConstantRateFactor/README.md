...
This sample shows how to create a custom encoding Transform using custom H.264 Constant Rate Factor (CRF) encoding settings. It shows how to perform the following tasks:

1. Creates a custom encoding transform using H.264 CRF
